...
\definecolor{codeFrame}{HTML}{E1E4EA}
\definecolor{codeNumber}{HTML}{6A737D}
...
% Richiede struttura marcata nel catalogo PDF (necessario per PDF/A-1a)
\pdfcatalog{/Lang(it-IT)/MarkInfo<</Marked true>>}
...
% Glossary entry marker (subscript G)
...
\makeglossaries
% Custom formatting: no colon separator, no auto-dot after description
\newcommand*{\glossaryentryfield}[5]{\item[\glsentryitem{#1}{#2}] #5}
\renewcommand*{\glspostdescription}{}
% Redefine the format for the glossary entries to be italic
\renewcommand*{\glstextformat}[1]{\textit{#1}\glox}

% Garantisce ancore Hyperref univoche per i listing (evita warning di destinazioni duplicate)
\providecommand*{\theHlisting}{\thechapter.\arabic{listing}}
%\glsaddall
...
\renewcommand\theFancyVerbLine{\textcolor{codeNumber}{\scriptsize\arabic{FancyVerbLine}}}
