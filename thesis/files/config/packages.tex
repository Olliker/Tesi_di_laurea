...
\PassOptionsToPackage{hyperfootnotes=false,hypertexnames=false}{hyperref} % evita warning Hfootnote/ancore duplicate
...
\usepackage{float} % per il posizionamento rigido delle figure
\usepackage{placeins} % per \FloatBarrier e controllo dei float
