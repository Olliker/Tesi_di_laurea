...
\begin{itemize}
    ...
    \item \textbf{Modulo di previsione}: modulo che aggiorna i dati, allena il modello, genera previsioni e notifica ErpAI via callback.
    \item \textbf{Modulo chatbot}: modulo che può interrogare il modulo di previsione via API per ottenere previsioni e spiegazioni da usare nelle risposte.
\end{itemize}
