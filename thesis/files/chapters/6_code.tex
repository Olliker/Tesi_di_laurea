...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{duckdb/}: servizio di sincronizzazione dati \gls{erp} con scheduler mensile.
        \item \textbf{kong/}: cartella contenente la configurazione del gateway API che espone i servizi interni.
        \item \textbf{openapi/}: servizio che pubblica la documentazione \acrshort{erp}.
