...
La tabella \ref{tab:copertura-requisiti} riporta un resoconto sul raggiungimento dei requisiti del capitolo~\ref{chap:analisi-requisiti}. Per ciascun requisito è indicato se è stato soddisfatto.
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|c|}
        \hline
        ...
        R.F.2 & No \\ \hline
    \end{tabular}
    \caption{Copertura dei requisiti del capitolo~\ref{chap:analisi-requisiti}}
