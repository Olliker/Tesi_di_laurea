...
\section{L'azienda}
Spazio Dev S.r.l. \ref{fig:logo-spaziodev} \footnote{\url{https://spaziodev.eu/}} è una realtà giovane, fondata nel 2023 a Tombolo (PD), che opera come partner tecnologico per aziende industriali e commerciali con un approccio aperto e flessibile. Offre sviluppo software su misura, integrazione di sistemi e servizi cloud; progetta siti web, e-commerce e soluzioni gestionali per migliorare i processi produttivi e commerciali, con focus su integrazioni affidabili e supporto post-rilascio.
\begin{figure}[H]
    \centering
