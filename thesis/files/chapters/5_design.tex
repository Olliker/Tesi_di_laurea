...
\captionof{listing}{Esempio di repository per Chroma (\texttt{code/repository\_pattern.py}).}
...
\captionof{listing}{Esempio di dependency injection (\texttt{forecasting\_service.py}).}
