...
Le attività sono tracciate su Plane\footnote{\url{https://plane.so}} con una board \gls{kanban} (Figura~\ref{fig:plane-board}) a quattro colonne: \textit{\gls{backlog}} raccoglie le attività proposte; \textit{Todo} contiene quelle selezionate per lo \gls{sprint}; \textit{In Progress} include il lavoro in corso; \textit{Done} raccoglie ciò che è completato.
