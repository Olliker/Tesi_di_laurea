...
\begin{risk}{Integrazione con l’\gls{erp} e le API}
    \riskdescription{ritardi o incongruenze nello scambio dati tra modulo di previsione, planning e \acrshort{erp}}
